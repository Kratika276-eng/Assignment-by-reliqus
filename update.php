...
<?php
		...
		$id = $_GET['id'];
		$class = mysqli_query($conn,"SELECT * FROM user_practice WHERE id = $id");
...
<body class="text-muted">
    <a href="list.php" class="btn btn-success">List</a>
									...
									<form action="update-conn.php?id=<?php echo $value['id']?>;" method="post" class="p-sm-3 panel panel-body" class="color">
										 			<?php
										...
										<div class="form-group  color">
											...
											<input type="text" value="<?php echo $value['name']?>;" class="form-control" placeholder="your name" name="name" id="recipient-name" >
										</div>
										<div class="form-group">
											<label for="email" class="col-form-label" style="color:black;">Email</label>
											<input type="email" value="<?php echo $value['email']?>;" class="form-control" placeholder="******" name="email" id="" >
										</div>

										
                                        <label for="">Gender</label>

                                        <select name="gender" value="<?php echo $value['gender']?>;" id="">
                                        ...
                                        <select name="status" value="<?php echo $value['status']?>;" id="">
